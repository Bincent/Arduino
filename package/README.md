...
2. Create a commit on master branch (directly or via a Pull Request), making the following changes:
...
8. Make a commit to master branch (directly or via a PR), updating:
